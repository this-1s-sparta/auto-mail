...
Το αρχείο EXCEL "dont_touch" πρέπει να έχει τα ΑΕΜ, Ο/Ε και email 'ΟΛΩΝ.
Το αρχείo EXCEL "grades" έχει τις βαθμολογίες.
(π.χ. για 2 διαφορετικά μαθήματα μπορεί να χρησιμοποιηθεί το ίδιο "dont_touch")

ΑΠΟ ΤΑ EXCEL ΔΕΝ ΠΡΈΠΕΙ ΝΑ ΔΙΑΓΡΑΦΟΥΝ ΟΙ ΠΡΏΤΕΣ ΓΡΑΜΜΕΣ!!!!!
